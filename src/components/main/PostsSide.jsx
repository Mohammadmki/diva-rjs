...
function PostsSide() {
  ...
  return (
        <div className='md:col-span-5 md:px-0 md:mb-0 mb-12  px-8 col-span-3 lg:col-span-9 xl:col-span-10 w-full flex flex-row flex-wrap gap-x-2 justify-center  overflow-hidden'>
      {post?.posts.map((post)=>(
