...
const navigate=useNavigate()
  ...
  setPost({category:"",city:"",amount:'',images:null,content:"",title:""})
  }
  ...
  return (
    <div className='relative md:mt-6 mt-12 flex w-[290px] md:w-[420px] px-3 container mx-auto my-5 flex-col'>
      ...
      <form onSubmit={submitHandler} onChange={changeHandler} className=' flex flex-col'>
        ...
        <input className='input mt-2 mb-4 md:mt-3 md:mb-7'  value={post["city"]} type="text" id='city' name='city' />
        <label className='md:text-base text-sm ' htmlFor="title">عنوان</label>
        <input className='input mt-2 mb-4 md:mt-3 md:mb-7'  value={post["title"]} type="text" name='title' id='title' />
        <label className='md:text-base text-sm ' htmlFor="amount">قیمت</label>
        <input className='input mt-2 mb-4 md:mt-3 md:mb-7'  value={post.amount} type="text" name='amount' id='amount' />
        <label className='md:text-base text-sm ' htmlFor="content">توضیحات اگهی </label>
        <textarea className='input mt-3 mb-7 h-44'  value={post["content"]} type="text" name='content' id='content' />
