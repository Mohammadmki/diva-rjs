...
import { savedpost } from '../features/post/savedSlice';
  ...
  return (
    <div className='grid grid-cols-2 gap-x-8 mt-32'>
      <div >
        ...
        <i onClick={()=>dispatch(savedpost(post.post))} className='transition-all duration-300 ease-in-out bg-white hover:bg-neutral-200  p-1 rounded-full'><BookmarkBorderOutlinedIcon  style={{fontSize:"1.3rem",color:"rgb(115,115,115)"}}/></i> 
        </div>
        </div>
